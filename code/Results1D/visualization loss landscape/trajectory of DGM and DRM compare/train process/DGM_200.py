...
for i in range(epoch):
    ...
    print("current DRM loss is: ", loss_else.detach())
    ...
    loss.backward()
    optimizer.step() 
    np.save("loss_of_DGM_200.npy", loss_record)
    np.save("loss_else_of_DGM_200.npy", loss_else_record)
    np.save("error_of_DGM_200.npy", error_record)
    np.save("eigen_vals_of_DGM_200.npy", eigen_vals_record)
np.save("loss_of_DGM_200.npy", loss_record)
np.save("loss_else_of_DGM_200.npy", loss_else_record)
np.save("error_of_DGM_200.npy", error_record)
np.save("eigen_vals_of_DGM_200.npy", eigen_vals_record)
