...
scheduler = lr_scheduler.StepLR(optimizer, 2500, 0.8) # every 4000 epoch, learning rate * 0.5
...
for j in range(100):
    ...
    for i in range(epoch):
        ...
        optimizer.step() 
        scheduler.step()
        np.save("loss_of_DGM_200_decay_meanstd.npy", loss_record)
        np.save("error_of_DGM_200_decay_meanstd.npy", error_record)
